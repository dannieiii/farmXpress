  ...
  setup() {
    ...
    const formData = ref({
      ...
      verificationDocs: {
        ...
        businessPermit: "No file chosen",
        farmCert: "No file chosen",
      },
      deliveryInfo: {
        deliveryMethod: "",
        operatingHours: "",
    ...
    const canSubmit = computed(() => {
      return formData.value.termsAgreement.agreeTerms && 
             formData.value.termsAgreement.consentData;
    });
    ...
    const submitForm = () => {
      // Copy personal info to seller object
      formData.value.seller.firstName = formData.value.personalInfo.firstName;
      formData.value.seller.lastName = formData.value.personalInfo.lastName;
      formData.value.seller.email = formData.value.personalInfo.email;
      formData.value.seller.contact = formData.value.personalInfo.contact;
      formData.value.seller.address = formData.value.personalInfo.address;
      formData.value.seller.wholesaleAvailability = formData.value.additionalDetails.wholesaleAvailability;
      
      // In a real app, you would send this data to your backend
      console.log('Form submitted:', formData.value);
      
      // Show success message
      alert('Your application has been submitted successfully! We will review your information and get back to you soon.');
